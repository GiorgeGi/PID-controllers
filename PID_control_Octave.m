...
The program was designed with Octave, but it works in MATLAB with a few changes (read comments)
...
pkg load control            % Load the control package for control system handling, comment this line so the code works in MATLAB as well
